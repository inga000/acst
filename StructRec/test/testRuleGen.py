...
cmdLineSingleSupplyLC =  [acst,"--circuit-netlist", cktSingleSupplyLC, "--device-types-file", deviceTypesFile, "--hspice-mapping-file", hspiceMappingFile, "--hspice-supplynet-file", hspiceSupplyNetFile, "--analysis", "rulegen", "--structure-name", "singleSupplyLC", "--xml-structrec-library-file", xmlLibFileArray, "--log-level-console","OFF"] 
